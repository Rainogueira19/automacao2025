...
public class Elementos {
	...
	// Elementos Compra
	public By botaoCheckout = By.xpath("//div//a[@class='btn_action checkout_button']");
	public By firstName = By.xpath("//div[@class='checkout_info']//input[1][@id='first-name']");
	...
	public By botaoCancel = By.xpath("//div//a[@class='cart_cancel_link btn_secondary']");
